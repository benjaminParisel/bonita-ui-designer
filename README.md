...
* Run it using `java -jar backend/target/ui-designer-1.11.69-standalone.jar`
...
backend/target/ui-designer-1.11.69.war
backend/target/ui-designer-1.11.69-standalone.jar
...
To run build standalone jar, just launch it as a standard jar :
    ...
    java -jar backend/target/ui-designer-1.11.69-standalone.jar [-Dworkspace=/path/to/workspace] [-Drepository.widgets=/path/widgets/repository] [-Drepository.pages=/path/pages/repository][-Dbonita.data.repository.origin=datarepository.url]
...
Available options can be listed by running 
    ...
    java -jar backend/target/ui-designer-1.11.69-standalone.jar -h
