...
* Run it using `java -jar backend/target/ui-designer-1.11.62-standalone.jar`
...
backend/target/ui-designer-1.11.62.war
backend/target/ui-designer-1.11.62-standalone.jar
...
To run build standalone jar, just launch it as a standard jar :
    ...
    java -jar backend/target/ui-designer-1.11.62-standalone.jar [-Dworkspace=/path/to/workspace] [-Drepository.widgets=/path/widgets/repository] [-Drepository.pages=/path/pages/repository][-Dbonita.data.repository.origin=datarepository.url]
...
Available options can be listed by running 
    ...
    java -jar backend/target/ui-designer-1.11.62-standalone.jar -h
